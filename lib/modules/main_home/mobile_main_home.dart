...
class MobileMainHomePage extends StatefulWidget {

  static String id = 'MobileMainHomePage';

  @override
  State<MobileMainHomePage> createState() => _DesktopMainHomePageState();
}

class _DesktopMainHomePageState extends State<MobileMainHomePage> {
        ...
        child: AppBar(
            ...
            actions: [
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, MobileMainHomePage.id);
                },
              ),
            ]),
      ),
