            ...
            Container(
              child: Row(
                children: [
                  ...
                  SocialWidget(
                    placeholderText:
                        'https://www.instagram.com/bsb48792023/', //text visible to viewers
                    ...
                    link:
                        'https://www.instagram.com/bsb48792023/', //provide the link
            ...
            Container(
              child: Row(
                children: [
                  ...
                  SocialWidget(
                    placeholderText:
                        'https://www.youtube.com/channel/UCCDTQA358TDL3qrpY6yQ0Bw', //text visible to viewers
                    iconData: SocialIconsFlutter.youtube,
                    iconSize: 40, //use the respective social logo
                    iconColor: Colors.red, //(optional, default - grey)
                    link:
                        'https://www.youtube.com/channel/UCCDTQA358TDL3qrpY6yQ0Bw', //provide the link
                    placeholderStyle: TextStyle(
                        color: Colors.blue,
                        fontSize: 15), //placeholder text style
                  ),
